...
import AnaliticosIcon from '../../../../shared/assets/icons/GeneracionAutomatica/AnaliticosIcon.svg';
import ArticulosGranelIcon from '../../../../shared/assets/icons/GeneracionAutomatica/ArticulosAGranelIcon.svg';
import ArticulosIcon from '../../../../shared/assets/icons/GeneracionAutomatica/ArticulosIcon.svg';
import CambiosPrecioIcon from '../../../../shared/assets/icons/GeneracionAutomatica/CambiosDePrecioIcon.svg';
import ExistenciasIcon from '../../../../shared/assets/icons/GeneracionAutomatica/ExistenciasIcon.svg';
import MovimientosIcon from '../../../../shared/assets/icons/GeneracionAutomatica/MovimientosIcon.svg';
import ProveedoresIcon from '../../../../shared/assets/icons/GeneracionAutomatica/ProveedoresIcon.svg';
import ResumenIcon from '../../../../shared/assets/icons/GeneracionAutomatica/ResumenIcon.svg';
import VentasIcon from '../../../../shared/assets/icons/GeneracionAutomatica/VentasIcon.svg';
...
export default function GeneracionAutomaticaReportes_TipoPage(){ 
            ...
            <main className="w-full h-full flex justify-center p-1 bg-gray-200">
                <div className="border border-black w-[70%] rounded-lg p-5 bg-white overflow-auto scrollbarclass">
                    <div className="p-5 flex items-center font-bold text-lg ml-10 gap-2">
                        ...
                        <h1>&rarr;</h1>
                        <h1 className='cursor-pointer'>Reportes</h1>
                    </div>
                    <hr />
