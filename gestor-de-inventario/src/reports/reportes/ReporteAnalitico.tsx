...
export default function ReporteAnalitico({children} : props){ 
  ...
  return (
      <div ref={contentRef} className='bg-white border border-black w-[794px] h-[1120px] max-w-[794px] max-h-[1120px] min-w-[794px] min-h-[1120px] flex flex-col  gap-5 overflow-auto'>
        {children}
      </div>
  )
}