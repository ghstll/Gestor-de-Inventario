...
export default function GeneracionAutomaticaNuevaConfig_Operacion(props : props) {
  ...
  return (
    <article className="flex gap-3">
        ...
        <select name="" id="" className="border border-black rounded-md p-1 bg-transparent" value={props.loadOperacion || ""} onChange={(e)=> props.setOperacionConfiguracion(e.target.value)}>
            {
