export default function GeneracionAutomaticaBtn({title,description,icon,onClickFunc} : {title : string , description : string , icon : string,onClickFunc? : () => void}){
    return(
        <div onClick={onClickFunc} className="flex justify-between items-center border border-black w-[80%] h-fit rounded-lg p-5 cursor-pointer hover:bg-gray-100 duration-700 " >
            <div>
